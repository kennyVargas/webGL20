...
const positionBuffer110 = gl.createBuffer();
const colorBuffer110 = gl.createBuffer();
const position110 = gl.getAttribLocation(program, 'position');
const mMatrix110 = gl.getUniformLocation(program, 'modelMatrix');
const color110 = gl.getAttribLocation(program, 'color');

const modelMatrix110 = mat4.create();
mat4.translate(
modelMatrix110,
modelMatrix110,
[0,0.5, 0]
...
gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer110);
gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(triangleCoords), gl.STATIC_DRAW);

gl.uniformMatrix4fv(mMatrix110, false, modelMatrix110);
gl.enableVertexAttribArray(position110);
gl.vertexAttribPointer(position110, 2, gl.FLOAT, gl.FALSE, 0, 0);

gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer110);
gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(trianguColor), gl.STATIC_DRAW);
gl.enableVertexAttribArray(color110);
gl.vertexAttribPointer(color110, 3, gl.FLOAT, gl.FALSE, 0, 0);
gl.drawArrays(gl.TRIANGLE_STRIP, 0, 4);  
//
// sombrero
//

const positionBuffer20 = gl.createBuffer();
const colorBuffer20 = gl.createBuffer();
const position20 = gl.getAttribLocation(program, 'position');
const mMatrix20 = gl.getUniformLocation(program, 'modelMatrix');
const color20 = gl.getAttribLocation(program, 'color');

const modelMatrix20 = mat4.create();
mat4.translate(
modelMatrix20,
modelMatrix20,
[0,.7, 0]
...
gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer20);
gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(sombrero), gl.STATIC_DRAW);

gl.uniformMatrix4fv(mMatrix20, false, modelMatrix20);
gl.enableVertexAttribArray(position20);
gl.vertexAttribPointer(position20, 2, gl.FLOAT, gl.FALSE, 0, 0);

gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer20);
gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(colorsombrero), gl.STATIC_DRAW);
gl.enableVertexAttribArray(color20);
gl.vertexAttribPointer(color20, 3, gl.FLOAT, gl.FALSE, 0, 0);
gl.drawArrays(gl.TRIANGLE_STRIP, 0, 4);
...
const positionBuffer21 = gl.createBuffer();
const colorBuffer21 = gl.createBuffer();
const position21 = gl.getAttribLocation(program, 'position');
const mMatrix21 = gl.getUniformLocation(program, 'modelMatrix');
const color21 = gl.getAttribLocation(program, 'color');

const modelMatrix21 = mat4.create();
mat4.translate(
modelMatrix21,
modelMatrix21,
[.5,-.1, 0]
...
gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer21);
gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(brazoDer), gl.STATIC_DRAW);

gl.uniformMatrix4fv(mMatrix21, false, modelMatrix21);
gl.enableVertexAttribArray(position21);
gl.vertexAttribPointer(position21, 2, gl.FLOAT, gl.FALSE, 0, 0);

gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer21);
gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(colorbrazoDer), gl.STATIC_DRAW);
gl.enableVertexAttribArray(color21);
gl.vertexAttribPointer(color21, 3, gl.FLOAT, gl.FALSE, 0, 0);
gl.drawArrays(gl.TRIANGLE_STRIP, 0, 4);

// brazoIzq
//

const positionBuffer22 = gl.createBuffer();
const colorBuffer22 = gl.createBuffer();
const position22 = gl.getAttribLocation(program, 'position');
const mMatrix22 = gl.getUniformLocation(program, 'modelMatrix');
const color22 = gl.getAttribLocation(program, 'color');

const modelMatrix22 = mat4.create();
mat4.translate(
modelMatrix22,
modelMatrix22,
[-.5,-.1, 0]
...
gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer22);
gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(brazoIqr), gl.STATIC_DRAW);

gl.uniformMatrix4fv(mMatrix22, false, modelMatrix22);
gl.enableVertexAttribArray(position22);
gl.vertexAttribPointer(position22, 2, gl.FLOAT, gl.FALSE, 0, 0);

gl.bindBuffer(gl.ARRAY_BUFFER, colorBuffer22);
gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(colorbrazoIqz), gl.STATIC_DRAW);
gl.enableVertexAttribArray(color22);
gl.vertexAttribPointer(color22, 3, gl.FLOAT, gl.FALSE, 0, 0);
gl.drawArrays(gl.TRIANGLE_STRIP, 0, 4);
